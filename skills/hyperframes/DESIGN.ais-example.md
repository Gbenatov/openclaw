...
Rounded pill, transparent fill, 1.5px `--ais-accent` border, Roboto Mono uppercase, 16–18px, 14–18px vertical + 28–36px horizontal padding.

Example: `[ JOIN THE SOCIETY → ]`

## Iconography

Thin stroke, 1.5–2px weight, accent-blue (`#37bdf8`), no fills. Chevron arrows (`»`), screens, charts.

## What NOT to Do

1. **No full-screen linear gradients** on dark backgrounds — H.264 banding. Use solid `--ais-bg` + localized radial glow.
2. **No neon pinks, purples, or saturated greens.** The palette is navy + cyan + white + warm orange. That’s it.
