...
# MarginV=90 keeps captions above platform UI on TikTok/Reels/Shorts (30% safe zone).
# Do not lower below ~75 without a specific platform reason.
SUB_FORCE_STYLE = (
...
def build_master_srt(edl: dict, edit_dir: Path, out_path: Path) -> None:
    ...
    2-word chunks, UPPERCASE, output times = word.start - seg_start + seg_offset.
    """
...
def build_final_composite(
    ...
    """Final pass: base → overlays (PTS-shifted) → subtitles LAST."""
...
def main() -> None:
    ...
    ap.add_argument(
        "--no-loudnorm",
        action="store_true",
        help="Skip audio loudness normalization (default: -14 LUFS / -1 dBTP / LRA 11).",
    )
    args = ap.parse_args()
